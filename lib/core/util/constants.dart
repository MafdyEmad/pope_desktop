class Constants {
  ...
  static const String deleteFile = '${_base}folders/deleteFile/';
  static const String deleteLink = '${_base}folders/link/';
  static const String uploadFile = '${_base}folders/upload/';
  static const String displayFile = '${_base}folders/media/';
  static const String addYoutubeLink = '${_base}folders/add-youtube-link/';
  static const String addSayings = '${_base}daily-sayings/add/';
